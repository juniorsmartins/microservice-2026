...
public class ApiVersionConfig implements WebMvcConfigurer {
    ...
    public void configureApiVersioning(ApiVersionConfigurer configurer) {
        configurer.usePathSegment(1) // Adicionar um resolvedor para extrair a versão de um segmento de caminho.
                .setVersionRequired(false) // Se as solicitações exigem obrigatoriamente uma versão de API.
